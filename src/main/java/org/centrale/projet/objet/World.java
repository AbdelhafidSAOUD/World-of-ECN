...
public class World {
    ...
    public World(String nomSauvegarde) throws Exception {
        ...
        this.creationJoueur();
            ...
            this.listEleJeu = w.listEleJeu;
            this.longueur = w.longueur;
    ...
    public void consommePosition(Personnage p) {
        ...
        objets.forEach((var objet) -> {
            if(objet instanceof Soin) {
                System.out.println("Vous avez consommé un soin !");
                ...
                System.out.println("Vous avez consommé un mana !");
                ...
                System.out.println("Vous avez consommé une nourriture !");
